...
\resumeItemListStart{}
\resumeItem{
	Provided expert guidance on cloud transformation for multiple companies, driving
	successful adoption of cloud-native technologies, including serverless and
	Kubernetes.
}
\resumeItem{
...
\resumeSubheading{SNCF Connect \& Tech}
{Since January 2024}
{GenAI Specialist Contractor}
\resumeItemListStart{}
\resumeItem{Undisclosed.}
\resumeItemListEnd{}


\resumeSubheading{Belmond}
{January 2024 - May 2024}
{Cloud Engineer Contractor}
\resumeItemListStart{}
\resumeItem{
	Managed the deployment of the application infrastructure across China and
	Europe, overcoming logistical challenges and ensuring compliance with local
	regulations.
}
\resumeItemListEnd{}
